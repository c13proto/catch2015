...
/*********************IOポート出力***********************/	
	SET_OUTPUT_PIN(PORTD,0);
	SET_OUTPUT_PIN(PORTD,1);	
	SET_OUTPUT_PIN(PORTD,2);
	SET_OUTPUT_PIN(PORTD,3);
	SET_OUTPUT_PIN(PORTD,4);
	SET_OUTPUT_PIN(PORTA,4);
	SET_OUTPUT_PIN(PORTA,5);
	SET_OUTPUT_PIN(PORTA,6);
	SET_OUTPUT_PIN(PORTA,7);
	SET_OUTPUT_PIN(PORTB,2);
	SET_OUTPUT_PIN(PORTB,3);
...
/*********************IOポート入力***********************/
	...
	SET_INPUT(PORTC);
	SET_INPUT_PIN(PORTD,5);
	SET_INPUT_PIN(PORTD,6);
	SET_INPUT_PIN(PORTD,7);
